...
WebUI.setText(findTestObject('Amazon_Signup_TC_001/Page_Amazon Registration/input_customerName'), ' Yaswanth teja')

WebUI.setText(findTestObject('Amazon_Signup_TC_001/Page_Amazon Registration/input_email'), 'nvsd@tewo.com')
